...
در این مثال سه ورودی داریم. وزن‌ها ۲، ۱ و منفی ۱ هستند و آستانهٔ فعال‌سازی داخل نورون به‌صورت <span class="math-inline">≥ 0.5</span> نوشته شده است.
...
بعد این مجموع را با آستانهٔ فعال‌سازی مقایسه می‌کنیم. چون <span class="math-inline">1 &gt; 0.5</span>، نورون فعال می‌شود و خروجی ۱ می‌دهد.

![نتیجه جمع وزن‌دار نورون](../assets/images/lesson-01-fa/lesson-01-05.svg)
نتیجهٔ محاسبه روی تخته <span class="math-inline">2 + 0 − 1 = 1</span> است و خروجی نورون نیز ۱ می‌شود.
...
گرادیان اطلاعات جهت را می‌دهد و در نقطهٔ کمینه روی شکل <span class="math-inline">∇F = 0</span> نوشته شده است.
...
فرمول روی تخته به‌صورت <span class="math-inline">σ(x) = 1/(1 + e<sup>−x</sup>)</span> نوشته می‌شود.
...
یک برنامه تابع <span class="math-inline">F(x, θ)</span> را محاسبه می‌کند. روی تخته نوشته شده است که <span class="math-inline">∇<sub>θ</sub>F</span> به ما اجازه می‌دهد <span class="math-inline">F</span> را آموزش دهیم و <span class="math-inline">∇<sub>x</sub>F</span> کمک می‌کند <span class="math-inline">F</span> را در یک مدل بزرگ‌تر یادگیری عمیق به‌کار ببریم.
