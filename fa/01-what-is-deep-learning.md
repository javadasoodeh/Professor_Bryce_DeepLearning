...
*فرمول روی تخته به‌صورت σ(x) = 1/(1 + e<sup>−x</sup>) نوشته می‌شود.*
...
*یک برنامه تابع F(x, θ) را محاسبه می‌کند. روی تخته نوشته شده است که ∇<sub>θ</sub>F به ما اجازه می‌دهد F را آموزش دهیم و ∇<sub>x</sub>F کمک می‌کند F را در یک مدل بزرگ‌تر یادگیری عمیق به‌کار ببریم.*
